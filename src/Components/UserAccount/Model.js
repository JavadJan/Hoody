        ...
        <div className="add_pin_modal">
            <div className="add_pin_container">
                ...
                <div className="side" id="right_side">
                    ...
                    <div className="section2">
                        <input placeholder="Add your item" type="text" className="new_pin_input" id="pin_title" />
                        <input placeholder="Tell everyone what your item is about" type="text" className="new_pin_input" id="pin_description" />
                        <input placeholder="Add your name" type="text" className="new_pin_input" id="pin_destination" />
                    </div>
                </div>
            </div>
        </div>
